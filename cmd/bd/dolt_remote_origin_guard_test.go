...
// gitOriginGetURL(), normalizeRemoteURL(), doltRemoteMatchesGitOrigin().
...
func TestNormalizeRemoteURL_TrailingSlash(t *testing.T) {
...
func TestNormalizeRemoteURL_DotGitSuffix(t *testing.T) {
...
func TestNormalizeRemoteURL_DotGitAndTrailingSlash(t *testing.T) {
	in := "https://github.com/org/repo.git/"
	want := "https://github.com/org/repo"
	if got := normalizeRemoteURL(in); got != want {
		t.Errorf("normalizeRemoteURL(%q) = %q, want %q", in, got, want)
...
func TestNormalizeRemoteURL_NoChange(t *testing.T) {
	in := "https://github.com/org/repo"
	if got := normalizeRemoteURL(in); got != in {
		t.Errorf("normalizeRemoteURL(%q) = %q, want unchanged %q", in, got, in)
	}
}

func TestNormalizeRemoteURL_SSHFormat(t *testing.T) {
...
func TestDoltRemoteMatchesGitOrigin_MatchingURL_ReturnsTrue(t *testing.T) {
	...
	// Exact match (same URL — normalizeRemoteURL strips .git)
