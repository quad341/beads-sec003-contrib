...
### be-0x25q — Tests: schema-skew guard (P1, validator)
...
```
be-wwbsv (impl) ──blocks──> be-0x25q (tests)
be-x0rl6 (docs)  ── independent
```

Builder ships be-wwbsv and be-x0rl6 in one PR. Validator writes be-0x25q after.
...
| be-0x25q | beads/validator | needs-tests |
