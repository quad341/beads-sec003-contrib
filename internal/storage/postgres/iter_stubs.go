// Package postgres — iter_stubs.go
//
...
func (s *PostgresStore) IterIssueComments(ctx context.Context, issueID string) (storage.Iter[types.Comment], error) {
...
func (s *PostgresStore) IterEvents(ctx context.Context, issueID string, limit int) (storage.Iter[types.Event], error) {
...
//
// TODO(be-yinl4d-iter): replace with a fully streaming implementation.
func (s *PostgresStore) IterAllEventsSince(ctx context.Context, since time.Time) (storage.Iter[types.Event], error) {
...
//
// TODO(be-yinl4d-iter): replace with a fully streaming implementation.
func (s *PostgresStore) IterReadyWork(ctx context.Context, filter types.WorkFilter) (storage.Iter[types.Issue], error) {
...
//
// TODO(be-yinl4d-iter): replace with a fully streaming implementation.
func (s *PostgresStore) IterBlockedIssues(ctx context.Context, filter types.WorkFilter) (storage.Iter[types.BlockedIssue], error) {
...
//
// TODO(be-yinl4d-iter): replace with a fully streaming implementation.
func (s *PostgresStore) IterWisps(ctx context.Context, filter types.WispFilter) (storage.Iter[types.Issue], error) {
...
//
// TODO(be-yinl4d-iter): replace with a fully streaming implementation.
func (s *PostgresStore) IterAllDependencyRecords(ctx context.Context) (storage.Iter[types.Dependency], error) {
	all, err := s.GetAllDependencyRecords(ctx)
	if err != nil {
		return nil, err
	}
	// Flatten the map[string][]*types.Dependency back into a slice. The
	// streaming impl will read directly from the dependencies table in
	// a single query without the map round-trip.
